                        ...
                        if (mat < 10272) {
                            if (mat < 10264) {
                                if (mat < 10260) { // Iron Bars
                                    ...
                                    if (mat == 10263) { // Powered Iron Door and Iron Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            } else {
                            ...
                            if (mat < 10504) {
                                if (mat < 10500) { // Torch
                                    ...
                                    if (color.r > 0.95) {
                                        ...
                                        #ifdef SOUL_SAND_VALLEY_OVERHAUL_INTERNAL
                                            if (color.g > 0.999) color.rgb = fireColor(color.rgb, 1.5, colorSoul, inSoulValley);
                                        #endif
                                        #ifdef PURPLE_END_FIRE_INTERNAL
                                            if (color.g > 0.5) color.rgb = fireColor(color.rgb, 2.0, colorEndBreath, 1.0);
                                        #endif
                                    } 
                    ...
                    if (mat < 10608) {
                        if (mat < 10592) {
                            if (mat < 10584) {
                                ...
                                if (mat < 10585) { // Candles:Lit, MV: Candles:Unlit
                                    noSmoothLighting = true;
                                ...
                                if (mat < 10748) { // Soul Sand, Soul Soil
                                    ...
                                    smoothnessD = color.r * 0.25;
                                        ...
                                        || blockUV.x < 0.375 && blockUV.z > 0.8125)) {
                                            ...
                                            color.rgb = fireColor(color.rgb, 80.0, colorSoul, noise);
                                            emission = 4.0 * noise;
                        ...
                        if (mat < 10784) {
                            ...
                            if (mat < 10792) {
                                ...
                                if (mat < 10796) { // Oak Door, Oak Trapdoor
                                    ...
                                    if (mat == 10795) { // Powered Oak Door and Oak Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                                    ...
                                    if (mat == 10799) { // Powered Spruce Door and TSpruce Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            }
                        ...
                        if (mat < 10816) {
                            if (mat < 10808) {
                                if (mat < 10804) { // Birch Door, Birch Trapdoor
                                    ...
                                    if (mat == 10803) { // Powered Birch Door and Birch Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                                    ...
                                    if (mat == 10807) { // Powered Jungle Door and Jungle Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            } else {
                                if (mat < 10812) { // Acacia Door, Acacia Trapdoor
                                    ...
                                    if (mat == 10811) { // Powered Acacia Door and Acacia Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                                    ...
                                    if (mat == 10815) { // Powered Dark Oak Door and Dark Oak Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            }
                            ...
                            if (mat < 10824) {
                                if (mat < 10820) { // Mangrove Door, Mangrove Trapdoor
                                    ...
                                    if (mat == 10819) { // Powered Mangrove Door and Mangrove Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                                    ...
                                    if (mat == 10823) { // Powered Crimson Door and Crimson Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            } else {
                                if (mat < 10828) { // Warped Door, Warped Trapdoor
                                    ...
                                    if (mat == 10827) { // Powered Warped Door and Warped Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                                    ...
                                    if (mat == 10831) { // Powered Bamboo Door and Bamboo Trapdoor
                                        redstoneIPBR(color.rgb, emission);
                                    }
                                }
                            }
